...
namespace LemmyNanny
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IWebhooksManager>(pro=> new WebhooksManager(pro.GetRequiredService<IHttpClientFactory>(), urls: builder.Configuration.GetRequiredSection("Webhooks").Get<List<WebhookConfig>>()!, DateTime.Now));
